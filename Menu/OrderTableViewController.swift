...
class OrderTableViewController: UITableViewController {
    ...
    //     pass data to labels and details
    ...
    //     create possibility to remove from order
    ...
    //    pass info to next segue, including prep time
    ...
    //     create notification when submit button is pressed with info
    ...
    //     unwind function to home, removing data
